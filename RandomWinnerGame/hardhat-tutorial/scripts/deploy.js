...
async function main() {
  /**
   * DeployContract in ethers.js is an abstraction used to deploy new smart contracts, so randomWinnerGame here is 
   * a factory for instances of our RandomWinnerGame contract.
   */
