...
import "./Whitelist.sol"; // Importing the Whitelist contract
...
contract CryptoDevs is ERC721Enumerable, Ownable {
    ...
    constructor(address whitelistContract) ERC721("Crypto Devs", "CD") Ownable(whitelistContract) {
        ...
        reservedTokens = whitelist.mawWhitelistedAddresses();
    }

    function mint() public payable {
        // Make sure we always leave enough room for whitelist reservations require 
        ...
        if(whitelist.whitelistedAddresses(msg.sender) && msg.value < _price) {
            ...
            require(msg.value >= _price, "INSUFFICIENT_ETH");
        }
