...
contract Exchange is ERC20 {
    ...
    // as it is responsible for minting anf issuing LP Tokens
    ...
    function addLiquidity(uint256 amountOfToken) public payable returns (uint256) {
        ...
        // If the reserve is empty, take any user supplie value for initial liquidity
        ...
        // If the reserve is not empty, calculate the amount of LP tokens 
    ...
    // getOutputAmountFromSwap() calculates the amount of output otkens to be received based on xy = (x-dx)(y-dy)
    function getOutputAmountFromSwap(uint256 inputAmount, uint256 inputReserve, uint256 outputReserve) public pure returns (uint256) {
        ...
        uint256 intputAmountWithFee = inputAmount * 99;
        uint256 numerator = intputAmountWithFee * outputReserve;
        uint256 denominator = (inputReserve * 100) + intputAmountWithFee;
