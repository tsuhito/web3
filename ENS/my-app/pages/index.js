...
export default function Home() {
  ...
  // In this case, whenever the value of 'walletConnected' changes, the effect will be triggered
  useEffect(() => {
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>
            Welcome to Tsuhito Punks {ens ? ens : address}!
          </h1>
          <div className={styles.description}>
            {/* Using HTML Entities for the apostrophe */}
            It&#39;s an NFT collection for Tsuhito Punks.
          </div>
          {renderButton()}
        </div>
      </div>
